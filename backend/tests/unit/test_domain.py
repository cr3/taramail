...
def test_domain_manager_get_origin_domain_without_alias(domain_manager, unique):
...
def test_domain_manager_get_origin_domain_with_alias(domain_manager, db_model, unique):
...
def test_domain_manager_get_domain_details(db_model, domain_manager, unique):
...
def test_domain_manager_delete_domain(db_model, domain_manager, unique):
